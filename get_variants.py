...
c_values = range(1, 5)
d_values = range(1, 5)
alpha_values = [0.5, 1.0]  # Coefficient for the abs term
scaling_factors = [0.1, 0.25, 0.5, 1.0]  # Scaling factors
loop_variations = [
...
def get_variation_algorithms():
    ...
    # Calculate statistics without generating all combinations
