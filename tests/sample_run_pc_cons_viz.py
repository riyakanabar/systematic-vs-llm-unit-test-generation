...
# from pc_const_adversarial_search.llms.iteration6 import test_cases

# pc_cons_fx = test_cases[9]['pc_fx']
# epsilon = test_cases[9]['epsilon']
...
plot_pc_cons_fx(pc_cons_fx, optimal_pc_fx, epsilon)