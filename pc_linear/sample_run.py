...
from pc_linear_adversarial_search.candidate_algorithms.modified_imai_iri import modified_imai_iri

pc_linear_fx = [(0.0, 1.0), (1.0, 1.0), (2.0, 3.0), (3.0, 8.0)] #18,19 good ones to test
epsilon = 0.5
