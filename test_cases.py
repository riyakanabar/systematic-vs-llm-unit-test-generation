...
test_cases = [
    ...
    (   #Testcase14
        [[-float('inf'), float('inf')],[0,1],[1,1],[2,2],[3,2],[4,3],[5,2],[6,2],[7,2],[8,1],[9,3],[10,float('inf')]],
        0.5
    ),
    (   #Testcase15
        [[-float('inf'), float('inf')],[0,8],[1,6],[2,6],[3,2],[4,3],[5,5],[6,5],[7,6],[8,8],[9,3],[10,float('inf')]],
        2
    ),
(   #Testcase16
        [[-float('inf'), float('inf')],[0,3],[1,4],[2,5],[3,7],[4,4],[5,6],[6,6],[7,5],[8,8],[9,4],[10,float('inf')]],
        1.5
    )
]
